...
def main():
    ...
    <div class='api-footer'>
        ...
        <br><span style='font-size:.65rem;color:#6B7A99'>Unique au monde — Photogrammétrie · Géocodage · Import CSV · Assistant vocal · Scanner cadre · Transhumance · Pedigree</span>
    </div>
    """, unsafe_allow_html=True)
